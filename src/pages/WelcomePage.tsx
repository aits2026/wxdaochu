    ...
    try {
      ...
      if (result.success) {
        ...
        if ('Notification' in window && Notification.permission === 'granted') {
          new Notification('VXdaochu - 图片密钥获取成功', {
        ...
        <div className="content-area">
          ...
          <div className="info-panel">
            <div className="panel-brand">
              <img src={appIcon === 'xinnian' ? "./xinnian.png" : "./logo.png"} alt="VXdaochu" className="brand-logo" />
              <div>
                <h1 className="brand-title">VXdaochu</h1>
