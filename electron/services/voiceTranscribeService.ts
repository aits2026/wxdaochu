...
export class VoiceTranscribeService {
    ...
    private initCacheDb(): void {
        try {
            ...
            const cacheDir = cachePath || join(app.getPath('appData'), 'vxdaochu')
    ...
    private resolveModelDir(): string {
        ...
        // Windows: C:\Users\<username>\AppData\Roaming\vxdaochu\models\sensevoice
        return join(app.getPath('appData'), 'vxdaochu', 'models', 'sensevoice')
    }
